...
/// A draggable mock of a Settings → Privacy list row: the user can grab this
/// row and drop it straight onto the Accessibility list in System Settings —
/// it drags the real .app bundle as a file URL.
final class PermissionDragRow: NSView, NSPasteboardItemDataProvider, NSDraggingSource {
